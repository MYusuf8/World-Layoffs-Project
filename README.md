...
Identified the maximum number of employees laid off and highest percentage laid off, including companies that laid off 100% of staff. 

Aggregated total layoffs per company and ranked them in descending order. 

Grouped total layoffs by industry and by country to identify the most affected sectors and regions.
